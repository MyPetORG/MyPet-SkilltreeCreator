...
/*
  Fire.tsx — Skill definition and editor for burning effect.

  Fields
  - Chance: percent chance to ignite target (string "+n").
  - Duration: duration in seconds the target burns (string "+n").
*/
...
function FireEditor({treeId, skillId, upgradeKey, value, onChange}: EditorProps) {
